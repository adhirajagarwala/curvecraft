...
- `examples/mosfet_id_vds_example.csv` is synthetic n-channel enhancement MOSFET-like Id-Vds output-curve data for M3 CSV loader tests and examples. It is not measured device data and must not be used as validation evidence.
